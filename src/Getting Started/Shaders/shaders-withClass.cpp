...
/////// OUR OWN SHADER CLASS ////
    ...
    Shader ourShader("src/Getting Started/Shaders/vertex.shader", "src/Getting Started/Shaders/fragment.shader");
...
//////// MORE ATTRIBUTES ////
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.use();
        ourShader.setFloat("xOffset", (float)mouseX);
        ourShader.setFloat("yOffset", (float)mouseY);
...
static void cursor_position_callback(GLFWwindow* window, double xpos, double ypos)
{
    int halfWidth = SCR_WIDTH / 2;
    int halfHeight = SCR_HEIGHT / 2;
    mouseX = (xpos - halfWidth) / halfWidth;
    mouseY = -(ypos - halfHeight) / halfHeight;
